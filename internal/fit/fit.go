...
func EncodeActivity(data ActivityData) ([]byte, error) {
	...
	recordDef := []byte{
		...
		0xFD, 0x04, 0x86, // timestamp
		0x05, 0x04, 0x86, // distance (Field 5, uint32, 100 * m)
		0x06, 0x02, 0x84, // speed (Field 6, uint16, mm/s)
		0x07, 0x02, 0x84, // power (Field 7, uint16, watts)
		0x03, 0x01, 0x02, // heart_rate (Field 3, uint8, bpm)
		0x04, 0x01, 0x02, // cadence (Field 4, uint8, rpm)
	}
